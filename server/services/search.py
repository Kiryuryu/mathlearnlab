...
def search_content_files(query: str, lang: str) -> list[dict]:
    """Search all .md files in CONTENT_DIR and CONTENT_DIR/en."""
    results = []
    query = query.lower()
    base = Path(CONTENT_DIR)

    def scan(directory: Path, en: bool):
        ...
        for md_file in directory.rglob("*.md"):
            ...
            try:
                ...
                results.append({
                    ...
                    "route": "/" + rel.replace(".md", "") if en else _route_for(rel),
